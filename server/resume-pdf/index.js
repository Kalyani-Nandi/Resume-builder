module.exports = (values) => {
    ...
    if (skill6 != "" && skill6 != null)
      ...
      htmlTemplate += `<p class="rela-block caps side-header">Languages</p>
                  <p class="rela-block list-thing">${language1}</p>`;
    if (language2 != "" && language2 != null)
      htmlTemplate += `<p class="rela-block list-thing">${language2}</p>`;
    if (language3 != "" && language3 != null)
      htmlTemplate += `<p class="rela-block list-thing">${language3}</p>`;
